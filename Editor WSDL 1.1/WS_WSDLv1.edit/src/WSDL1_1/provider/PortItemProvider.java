...
/**
 * This is the item provider adapter for a {@link WSDL1_1.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WSDL1_1Package.eINSTANCE.getPort_Name(),
				 true,
				 false,
				 false,
	...
	protected void addBindingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_binding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_binding_feature", "_UI_Port_type"),
				 WSDL1_1Package.eINSTANCE.getPort_Binding(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getPort_SoapAddress());
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getPort_HttpAddress());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getPort_SoapAddress(),
				 WSDL1_1Factory.eINSTANCE.createAddressSOAP()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getPort_HttpAddress(),
				 WSDL1_1Factory.eINSTANCE.createAddressHTTP()));
	}
