...
public interface ASDPackage extends EPackage
{
   ...
   * @ordered
   */
  int ASSERTION__INTENTION = NAMED_ELEMENT_FEATURE_COUNT + 2;
  ...
  /**
   * Returns the meta object for the attribute '{@link ASD.Assertion#getIntention <em>Intention</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Intention</em>'.
   * @see ASD.Assertion#getIntention()
   * @see #getAssertion()
   * @generated
   */
  EAttribute getAssertion_Intention();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute ASSERTION__INTENTION = eINSTANCE.getAssertion_Intention();
