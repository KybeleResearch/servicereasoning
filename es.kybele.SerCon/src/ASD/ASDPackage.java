...
public interface ASDPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int INFO_TYPE__MESSAGE = NAMED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int INFO_TYPE__SERVICE = NAMED_ELEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int INFO_TYPE_FEATURE_COUNT = NAMED_ELEMENT_FEATURE_COUNT + 6;
	...
	/**
	 * Returns the meta object for the reference list '{@link ASD.InfoType#getInfoType <em>Info Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Info Type</em>'.
	...
	/**
	 * Returns the meta object for the reference '{@link ASD.InfoType#getMessage <em>Message</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
