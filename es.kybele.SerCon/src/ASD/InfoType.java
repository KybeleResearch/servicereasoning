...
public interface InfoType extends NamedElement {
	 ...
	 * @model annotation="gmf.link source.decoration='square' target.decoration='square' style='dash' tool.description='Relationship between InfoTypes'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ASD.InfoType#getMessage <em>Message</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
