...
<ASD:ServiceDescription xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:ASD="http://ASD" name="SD1">
  ...
  <profiles name="Profile1">
    <sets name="ASet1">
      ...
      <assertions name="Assert2" dimension="latency" dimensionType="antitonic" minVal="0.05" maxVal="0.15"/>
      <assertions name="Assert3" dimension="performance" minVal="70.0" maxVal="100.0"/>
    </sets>
  </profiles>
