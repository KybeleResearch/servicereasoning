...
public class XML2WSDLLaunchShortcut implements ILaunchShortcut {
	...
	public static final String MODEL_CONFIGTYPE_ID = Activator.PLUGIN_ID + ".XML2WSDLv1_1_lct";
	...
	protected ILaunchConfiguration createConfiguration(String pathIN) {
		...
		try {
			...
			wc.setAttribute("outModel", new Path(pathIN).removeFileExtension().toOSString() + "-wsdlv1.xmi");
			config = wc.doSave();
