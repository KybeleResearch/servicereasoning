 ...
 * <ul>
 *   <li>{@link WSDL1_1.impl.AnyImpl#getNamespace <em>Namespace</em>}</li>
 *   <li>{@link WSDL1_1.impl.AnyImpl#getProcessContents <em>Process Contents</em>}</li>
 *   <li>{@link WSDL1_1.impl.AnyImpl#getMinOccurs <em>Min Occurs</em>}</li>
 *   <li>{@link WSDL1_1.impl.AnyImpl#getMaxOccurs <em>Max Occurs</em>}</li>
 *   <li>{@link WSDL1_1.impl.AnyImpl#getId <em>Id</em>}</li>
 *   <li>{@link WSDL1_1.impl.AnyImpl#getAnnotation <em>Annotation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnyImpl extends EObjectImpl implements Any {
	...
	protected EClass eStaticClass() {
		return WSDL1_1Package.eINSTANCE.getAny();
	}
	...
	public void setNamespace(String newNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ANY__NAMESPACE, oldNamespace, namespace));
	}
	...
	public void setProcessContents(processContentsValue newProcessContents) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ANY__PROCESS_CONTENTS, oldProcessContents, processContents));
	}
	...
	public void setMinOccurs(Integer newMinOccurs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ANY__MIN_OCCURS, oldMinOccurs, minOccurs));
	}
	...
	public void setMaxOccurs(String newMaxOccurs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ANY__MAX_OCCURS, oldMaxOccurs, maxOccurs));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ANY__ID, oldId, id));
	}
	...
	public NotificationChain basicSetAnnotation(Annotation newAnnotation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ANY__ANNOTATION, oldAnnotation, newAnnotation);
	...
	public void setAnnotation(Annotation newAnnotation) {
		if (newAnnotation != annotation) {
			...
			if (annotation != null)
				msgs = ((InternalEObject)annotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.ANY__ANNOTATION, null, msgs);
			if (newAnnotation != null)
				msgs = ((InternalEObject)newAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.ANY__ANNOTATION, null, msgs);
			msgs = basicSetAnnotation(newAnnotation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ANY__ANNOTATION, newAnnotation, newAnnotation));
	}
