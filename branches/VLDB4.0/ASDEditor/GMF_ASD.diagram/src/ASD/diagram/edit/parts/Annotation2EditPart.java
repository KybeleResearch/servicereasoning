...
import ASD.diagram.edit.policies.Annotation2ItemSemanticEditPolicy;
...
public class Annotation2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AnnotationKey3EditPart) {
			((AnnotationKey3EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureAnnotationLabelFigure());
			return true;
		}
		if (childEditPart instanceof AnnotationKey4EditPart) {
			((AnnotationKey4EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureAnnotationKeyLabelFigure());
			return true;
		}
		if (childEditPart instanceof AnnotationValue2EditPart) {
			((AnnotationValue2EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ASDVisualIDRegistry
				.getType(AnnotationKey3EditPart.VISUAL_ID));
	}
