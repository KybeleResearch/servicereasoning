...
import ASD.diagram.edit.policies.InfoTypeImportedItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InfoTypeImportedEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InfoTypeImportedEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InfoTypeImportedItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InfoTypeImportedNameEditPart) {
			((InfoTypeImportedNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureInfoTypeImportedLabelFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeImportedName2EditPart) {
			((InfoTypeImportedName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureNamedElementNameLabelFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeImportedValueTypeEditPart) {
			((InfoTypeImportedValueTypeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureInfoTypeValueTypeLabelFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeImportedValueRangeEditPart) {
			((InfoTypeImportedValueRangeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureInfoTypeValueRangeLabelFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeImportedSubsetEditPart) {
			((InfoTypeImportedSubsetEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureInfoTypeSubsetLabelFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeImportedUrlEditPart) {
			((InfoTypeImportedUrlEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureInfoTypeImportedUrlLabelFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeImportedInfoTypeImportedAnnotationsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getInfoTypeImportedAnnotationsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InfoTypeImportedInfoTypeImportedAnnotationsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeImportedInfoTypeImportedInfoTypeCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getInfoTypeImportedInfoTypeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InfoTypeImportedInfoTypeImportedInfoTypeCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof InfoTypeImportedInfoTypeImportedAnnotationsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getInfoTypeImportedAnnotationsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((InfoTypeImportedInfoTypeImportedAnnotationsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeImportedInfoTypeImportedInfoTypeCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getInfoTypeImportedInfoTypeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((InfoTypeImportedInfoTypeImportedInfoTypeCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ASD.diagram.edit.parts.InfoTypeImportedEditPart) {
			types.add(ASDElementTypes.InfoTypeRef_4002);
		}
