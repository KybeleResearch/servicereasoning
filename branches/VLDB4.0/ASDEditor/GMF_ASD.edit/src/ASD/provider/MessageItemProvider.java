...
/**
 * This is the item provider adapter for a {@link ASD.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Message_role_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Message_role_feature", "_UI_Message_type"),
         ASDPackage.Literals.MESSAGE__ROLE,
         true,
         false,
         false,
  ...
  protected void addSubsetPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Message_subset_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Message_subset_feature", "_UI_Message_type"),
         ASDPackage.Literals.MESSAGE__SUBSET,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  protected void addInfoTypePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Message_infoType_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Message_infoType_feature", "_UI_Message_type"),
         ASDPackage.Literals.MESSAGE__INFO_TYPE,
         true,
         false,
         true,
         null,
