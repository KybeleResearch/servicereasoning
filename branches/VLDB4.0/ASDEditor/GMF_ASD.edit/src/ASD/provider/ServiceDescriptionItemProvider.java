...
/**
 * This is the item provider adapter for a {@link ASD.ServiceDescription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceDescriptionItemProvider
    ...
    IItemPropertySource
{
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ASDPackage.Literals.SERVICE_DESCRIPTION__OPERATIONS);
      childrenFeatures.add(ASDPackage.Literals.SERVICE_DESCRIPTION__INFOTYPES);
      childrenFeatures.add(ASDPackage.Literals.SERVICE_DESCRIPTION__PROFILES);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (ASDPackage.Literals.SERVICE_DESCRIPTION__OPERATIONS,
         ASDFactory.eINSTANCE.createOperation()));

    newChildDescriptors.add
      (createChildParameter
        (ASDPackage.Literals.SERVICE_DESCRIPTION__INFOTYPES,
    ...
    newChildDescriptors.add
      (createChildParameter
        (ASDPackage.Literals.SERVICE_DESCRIPTION__PROFILES,
         ASDFactory.eINSTANCE.createProfile()));
  }
