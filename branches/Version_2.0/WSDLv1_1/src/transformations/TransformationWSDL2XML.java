...
public class TransformationWSDL2XML {
	...
	private void loadProperties() throws Exception {
		...
		properties.load(getFileURL("WSDL2XMLv1.properties").openStream());
	...
	protected InputStream[] getModulesList() throws IOException {
		...
		String modulesList = properties.getProperty("WSDL2XMLv1.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("WSDL2XMLv1.metamodels." + metamodelName);
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("WSDL2XMLv1.options.")) {
				options.put(entry.getKey().toString().replaceFirst("WSDL2XMLv1.options.", ""), 
