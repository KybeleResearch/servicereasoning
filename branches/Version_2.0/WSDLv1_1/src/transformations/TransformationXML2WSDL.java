...
public class TransformationXML2WSDL {
	...
	public void XML2WSDL(String in, String out) throws Exception{
		...
		InputStream input = FileLocator.openStream(b, new Path("/src/transformations/Metamodels/wsdl1_1.ecore"), false);
		input.close();
	}
	...
	private Object execution(IProgressMonitor monitor) throws Exception {
		...
		launcher.addLibrary("XMLHelpersv1", getLibraryAsStream("XMLHelpers"));
	...
	private void loadModels(String in) throws ATLCoreException, IOException {
		...
		injector.inject(wsdlMetamodel, getFileURL("Metamodels/wsdl1_1.ecore").toString());
	...
	private void loadProperties() throws Exception {
		...
		properties.load(getFileURL("XML2WSDLv1.properties").openStream());
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("ecore", new EcoreResourceFactoryImpl());	
	}
	
	protected InputStream[] getModulesList() throws IOException {
		InputStream[] modules = null;
		String modulesList = properties.getProperty("XML2WSDLv1.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("XML2WSDLv1.metamodels." + metamodelName);
	}
	
	
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("XML2WSDLv1.libraries." + libraryName)).openStream();
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("XML2WSDLv1.options.")) {
				options.put(entry.getKey().toString().replaceFirst("XML2WSDLv1.options.", ""), 
