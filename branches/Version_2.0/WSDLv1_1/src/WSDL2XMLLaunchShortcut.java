...
public class WSDL2XMLLaunchShortcut implements ILaunchShortcut {
	
	public static final String MODEL_CONFIGTYPE_ID = Activator.PLUGIN_ID + ".WSDL2XMLv1_1_lct";
	...
	protected ILaunchConfiguration createConfiguration(String pathIN) {
		...
		try {
			...
			wc.setAttribute("outModel", new Path(pathIN).removeFileExtension().toOSString() + "-xml.xmi");
			config = wc.doSave();
