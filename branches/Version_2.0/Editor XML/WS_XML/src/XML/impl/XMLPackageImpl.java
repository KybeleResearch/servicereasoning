...
public class XMLPackageImpl extends EPackageImpl implements XMLPackage {
	...
	public void createPackageContents() {
		...
		createEAttribute(nodeEClass, NODE__START_LINE);
		createEAttribute(nodeEClass, NODE__START_COLUMN);
		createEAttribute(nodeEClass, NODE__END_LINE);
		createEAttribute(nodeEClass, NODE__END_COLUMN);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNode_StartLine(), ecorePackage.getEIntegerObject(), "startLine", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getNode_StartColumn(), ecorePackage.getEIntegerObject(), "startColumn", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getNode_EndLine(), ecorePackage.getEIntegerObject(), "endLine", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getNode_EndColumn(), ecorePackage.getEIntegerObject(), "endColumn", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
