...
public class ASDFactoryImpl extends EFactoryImpl implements ASDFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ASDPackage.INFO_TYPE_IMPORTED: return createInfoTypeImported();
			default:
	 ...
	 * @generated
	 */
	public InfoTypeImported createInfoTypeImported() {
		InfoTypeImportedImpl infoTypeImported = new InfoTypeImportedImpl();
		return infoTypeImported;
	}
