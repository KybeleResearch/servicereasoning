...
/**
 * This is the item provider adapter for a {@link WSDL1_1.Enumeration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WSDL1_1Package.eINSTANCE.getEnumeration_Value(),
				 true,
				 false,
				 false,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Enumeration_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Enumeration_id_feature", "_UI_Enumeration_type"),
				 WSDL1_1Package.eINSTANCE.getEnumeration_Id(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getEnumeration_Annotation());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getEnumeration_Annotation(),
