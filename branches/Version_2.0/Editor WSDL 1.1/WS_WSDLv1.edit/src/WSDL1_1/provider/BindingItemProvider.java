...
/**
 * This is the item provider adapter for a {@link WSDL1_1.Binding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BindingItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WSDL1_1Package.eINSTANCE.getBinding_Name(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WSDL1_1Package.eINSTANCE.getBinding_Type(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getBinding_Operation());
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getBinding_Soapbinding());
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getBinding_Httpbinding());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getBinding_Operation(),
				 WSDL1_1Factory.eINSTANCE.createBindingOperation()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getBinding_Soapbinding(),
				 WSDL1_1Factory.eINSTANCE.createBindingSOAP()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getBinding_Httpbinding(),
				 WSDL1_1Factory.eINSTANCE.createBindingHTTP()));
	}
