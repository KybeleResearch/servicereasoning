 ...
 * <ul>
 *   <li>{@link WSDL1_1.impl.BindingInputImpl#getBody <em>Body</em>}</li>
 *   <li>{@link WSDL1_1.impl.BindingInputImpl#getHeader <em>Header</em>}</li>
 *   <li>{@link WSDL1_1.impl.BindingInputImpl#getUrlReplacement <em>Url Replacement</em>}</li>
 *   <li>{@link WSDL1_1.impl.BindingInputImpl#getUrlEncoded <em>Url Encoded</em>}</li>
 *   <li>{@link WSDL1_1.impl.BindingInputImpl#getMultipartRelated <em>Multipart Related</em>}</li>
 *   <li>{@link WSDL1_1.impl.BindingInputImpl#getContent <em>Content</em>}</li>
 *   <li>{@link WSDL1_1.impl.BindingInputImpl#getMimeXml <em>Mime Xml</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BindingInputImpl extends ObjectImpl implements BindingInput {
	/**
	...
	protected EClass eStaticClass() {
		return WSDL1_1Package.eINSTANCE.getBindingInput();
	}
	...
	public EList<BodySOAP> getBody() {
		if (body == null) {
			body = new EObjectContainmentEList<BodySOAP>(BodySOAP.class, this, WSDL1_1Package.BINDING_INPUT__BODY);
		}
		return body;
	}
	...
	public EList<HeaderSOAP> getHeader() {
		if (header == null) {
			header = new EObjectContainmentEList<HeaderSOAP>(HeaderSOAP.class, this, WSDL1_1Package.BINDING_INPUT__HEADER);
		}
		return header;
	}
	...
	public NotificationChain basicSetUrlReplacement(URLReplacement newUrlReplacement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WSDL1_1Package.BINDING_INPUT__URL_REPLACEMENT, oldUrlReplacement, newUrlReplacement);
	...
	public void setUrlReplacement(URLReplacement newUrlReplacement) {
		if (newUrlReplacement != urlReplacement) {
			...
			if (urlReplacement != null)
				msgs = ((InternalEObject)urlReplacement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.BINDING_INPUT__URL_REPLACEMENT, null, msgs);
			if (newUrlReplacement != null)
				msgs = ((InternalEObject)newUrlReplacement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.BINDING_INPUT__URL_REPLACEMENT, null, msgs);
			msgs = basicSetUrlReplacement(newUrlReplacement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.BINDING_INPUT__URL_REPLACEMENT, newUrlReplacement, newUrlReplacement));
	}
	...
	public NotificationChain basicSetUrlEncoded(URLEncoded newUrlEncoded, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WSDL1_1Package.BINDING_INPUT__URL_ENCODED, oldUrlEncoded, newUrlEncoded);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUrlEncoded(URLEncoded newUrlEncoded) {
		if (newUrlEncoded != urlEncoded) {
			NotificationChain msgs = null;
			if (urlEncoded != null)
				msgs = ((InternalEObject)urlEncoded).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.BINDING_INPUT__URL_ENCODED, null, msgs);
			if (newUrlEncoded != null)
				msgs = ((InternalEObject)newUrlEncoded).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.BINDING_INPUT__URL_ENCODED, null, msgs);
			msgs = basicSetUrlEncoded(newUrlEncoded, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.BINDING_INPUT__URL_ENCODED, newUrlEncoded, newUrlEncoded));
	}
	...
	public EList<MIMEMultiPartRelated> getMultipartRelated() {
		if (multipartRelated == null) {
			multipartRelated = new EObjectContainmentEList<MIMEMultiPartRelated>(MIMEMultiPartRelated.class, this, WSDL1_1Package.BINDING_INPUT__MULTIPART_RELATED);
		}
	...
	public EList<MIMEContent> getContent() {
		if (content == null) {
			content = new EObjectContainmentEList<MIMEContent>(MIMEContent.class, this, WSDL1_1Package.BINDING_INPUT__CONTENT);
		}
		return content;
	}
	...
	public EList<MIMEXml> getMimeXml() {
		if (mimeXml == null) {
			mimeXml = new EObjectContainmentEList<MIMEXml>(MIMEXml.class, this, WSDL1_1Package.BINDING_INPUT__MIME_XML);
		}
		return mimeXml;
	}
