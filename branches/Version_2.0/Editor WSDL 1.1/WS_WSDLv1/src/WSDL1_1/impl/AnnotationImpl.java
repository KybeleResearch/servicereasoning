 ...
 * <ul>
 *   <li>{@link WSDL1_1.impl.AnnotationImpl#getAppinfo <em>Appinfo</em>}</li>
 *   <li>{@link WSDL1_1.impl.AnnotationImpl#getDocumentation <em>Documentation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotationImpl extends EObjectImpl implements Annotation {
	...
	protected EClass eStaticClass() {
		return WSDL1_1Package.eINSTANCE.getAnnotation();
	}
	...
	public EList<AppInfo> getAppinfo() {
		if (appinfo == null) {
			appinfo = new EObjectContainmentEList<AppInfo>(AppInfo.class, this, WSDL1_1Package.ANNOTATION__APPINFO);
		}
		return appinfo;
	}
	...
	public EList<DocumentationXMLSchema> getDocumentation() {
		if (documentation == null) {
			documentation = new EObjectContainmentEList<DocumentationXMLSchema>(DocumentationXMLSchema.class, this, WSDL1_1Package.ANNOTATION__DOCUMENTATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WSDL1_1Package.ANNOTATION__APPINFO:
				return ((InternalEList<?>)getAppinfo()).basicRemove(otherEnd, msgs);
			case WSDL1_1Package.ANNOTATION__DOCUMENTATION:
