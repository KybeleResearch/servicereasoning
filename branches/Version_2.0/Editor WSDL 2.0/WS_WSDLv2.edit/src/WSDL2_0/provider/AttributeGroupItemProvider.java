...
/**
 * This is the item provider adapter for a {@link WSDL2_0.AttributeGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeGroupItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WSDL2_0Package.eINSTANCE.getAttributeGroup_Name(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WSDL2_0Package.eINSTANCE.getAttributeGroup_Id(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WSDL2_0Package.eINSTANCE.getAttributeGroup_Ref(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WSDL2_0Package.eINSTANCE.getAttributeGroup_Annotation());
			childrenFeatures.add(WSDL2_0Package.eINSTANCE.getAttributeGroup_Attribute());
			childrenFeatures.add(WSDL2_0Package.eINSTANCE.getAttributeGroup_AttributeGroup());
			childrenFeatures.add(WSDL2_0Package.eINSTANCE.getAttributeGroup_AnyAttribute());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WSDL2_0Package.eINSTANCE.getAttributeGroup_Annotation(),
				 WSDL2_0Factory.eINSTANCE.createAnnotation()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL2_0Package.eINSTANCE.getAttributeGroup_Attribute(),
				 WSDL2_0Factory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL2_0Package.eINSTANCE.getAttributeGroup_AttributeGroup(),
				 WSDL2_0Factory.eINSTANCE.createAttributeGroup()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL2_0Package.eINSTANCE.getAttributeGroup_AnyAttribute(),
