 ...
 * <ul>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getNds <em>Nds</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getNsSchema <em>Ns Schema</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getFinalDefault <em>Final Default</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getBlockDefault <em>Block Default</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getId <em>Id</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getElementFormDefault <em>Element Form Default</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getAttributeFormDefault <em>Attribute Form Default</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getXml_lang <em>Xml lang</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getInclude <em>Include</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getImport <em>Import</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getRedefine <em>Redefine</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getSimpleType <em>Simple Type</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getComplexType <em>Complex Type</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getElement <em>Element</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getAttributeGroup <em>Attribute Group</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link WSDL2_0.impl.SchemaImpl#getNotation <em>Notation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SchemaImpl extends EObjectImpl implements Schema {
	 ...
	 * @ordered
	 */
	protected EList<IncludeXMLSchema> include;
	...
	protected EClass eStaticClass() {
		return WSDL2_0Package.eINSTANCE.getSchema();
	}
	...
	public void setTargetNamespace(String newTargetNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.SCHEMA__TARGET_NAMESPACE, oldTargetNamespace, targetNamespace));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.SCHEMA__VERSION, oldVersion, version));
	}
	...
	public void setNds(String newNds) {
		...
		nds = newNds;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.SCHEMA__NDS, oldNds, nds));
	}
	...
	public void setNsSchema(String newNsSchema) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.SCHEMA__NS_SCHEMA, oldNsSchema, nsSchema));
	}
	...
	public void setFinalDefault(String newFinalDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.SCHEMA__FINAL_DEFAULT, oldFinalDefault, finalDefault));
	}
	...
	public void setBlockDefault(String newBlockDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.SCHEMA__BLOCK_DEFAULT, oldBlockDefault, blockDefault));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.SCHEMA__ID, oldId, id));
	}
	...
	public void setElementFormDefault(formValues newElementFormDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.SCHEMA__ELEMENT_FORM_DEFAULT, oldElementFormDefault, elementFormDefault));
	}
	...
	public void setAttributeFormDefault(formValues newAttributeFormDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.SCHEMA__ATTRIBUTE_FORM_DEFAULT, oldAttributeFormDefault, attributeFormDefault));
	}
	...
	public void setXml_lang(String newXml_lang) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.SCHEMA__XML_LANG, oldXml_lang, xml_lang));
	}
	 ...
	 * @generated
	 */
	public EList<IncludeXMLSchema> getInclude() {
		if (include == null) {
			include = new EObjectContainmentEList<IncludeXMLSchema>(IncludeXMLSchema.class, this, WSDL2_0Package.SCHEMA__INCLUDE);
		}
		return include;
	}
	...
	public EList<ImportXMLSchema> getImport() {
		if (import_ == null) {
			import_ = new EObjectContainmentEList<ImportXMLSchema>(ImportXMLSchema.class, this, WSDL2_0Package.SCHEMA__IMPORT);
		}
		return import_;
	}
	...
	public EList<Redefine> getRedefine() {
		if (redefine == null) {
			redefine = new EObjectContainmentEList<Redefine>(Redefine.class, this, WSDL2_0Package.SCHEMA__REDEFINE);
		}
		return redefine;
	}
	...
	public EList<Annotation> getAnnotation() {
		if (annotation == null) {
			annotation = new EObjectContainmentEList<Annotation>(Annotation.class, this, WSDL2_0Package.SCHEMA__ANNOTATION);
		}
		return annotation;
	}
	...
	public EList<SimpleType> getSimpleType() {
		if (simpleType == null) {
			simpleType = new EObjectContainmentEList<SimpleType>(SimpleType.class, this, WSDL2_0Package.SCHEMA__SIMPLE_TYPE);
		}
		return simpleType;
	}
	...
	public EList<ComplexType> getComplexType() {
		if (complexType == null) {
			complexType = new EObjectContainmentEList<ComplexType>(ComplexType.class, this, WSDL2_0Package.SCHEMA__COMPLEX_TYPE);
		}
		return complexType;
	}
	...
	public EList<Element> getElement() {
		if (element == null) {
			element = new EObjectContainmentEList<Element>(Element.class, this, WSDL2_0Package.SCHEMA__ELEMENT);
		}
		return element;
	}
	...
	public EList<Attribute> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList<Attribute>(Attribute.class, this, WSDL2_0Package.SCHEMA__ATTRIBUTE);
		}
		return attribute;
	}
	...
	public EList<AttributeGroup> getAttributeGroup() {
		if (attributeGroup == null) {
			attributeGroup = new EObjectContainmentEList<AttributeGroup>(AttributeGroup.class, this, WSDL2_0Package.SCHEMA__ATTRIBUTE_GROUP);
		}
	...
	public EList<Group> getGroup() {
		if (group == null) {
			group = new EObjectContainmentEList<Group>(Group.class, this, WSDL2_0Package.SCHEMA__GROUP);
		}
		return group;
	}
	...
	public EList<Notation> getNotation() {
		if (notation == null) {
			notation = new EObjectContainmentEList<Notation>(Notation.class, this, WSDL2_0Package.SCHEMA__NOTATION);
		}
		return notation;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case WSDL2_0Package.SCHEMA__INCLUDE:
				getInclude().clear();
				getInclude().addAll((Collection<? extends IncludeXMLSchema>)newValue);
				return;
			case WSDL2_0Package.SCHEMA__IMPORT:
				getImport().clear();
