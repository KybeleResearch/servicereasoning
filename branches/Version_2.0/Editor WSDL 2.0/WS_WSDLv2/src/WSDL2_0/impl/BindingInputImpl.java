 ...
 * <ul>
 *   <li>{@link WSDL2_0.impl.BindingInputImpl#getMessageLabel <em>Message Label</em>}</li>
 *   <li>{@link WSDL2_0.impl.BindingInputImpl#getWhttp_contentEncoding <em>Whttp content Encoding</em>}</li>
 *   <li>{@link WSDL2_0.impl.BindingInputImpl#getWsoap_module <em>Wsoap module</em>}</li>
 *   <li>{@link WSDL2_0.impl.BindingInputImpl#getWsoap_header <em>Wsoap header</em>}</li>
 *   <li>{@link WSDL2_0.impl.BindingInputImpl#getWhttp_header <em>Whttp header</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BindingInputImpl extends ObjectImpl implements BindingInput {
	...
	protected EClass eStaticClass() {
		return WSDL2_0Package.eINSTANCE.getBindingInput();
	}
	...
	public void setMessageLabel(String newMessageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.BINDING_INPUT__MESSAGE_LABEL, oldMessageLabel, messageLabel));
	}
	...
	public void setWhttp_contentEncoding(String newWhttp_contentEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.BINDING_INPUT__WHTTP_CONTENT_ENCODING, oldWhttp_contentEncoding, whttp_contentEncoding));
	}
	...
	public EList<Wsoap_Module> getWsoap_module() {
		if (wsoap_module == null) {
			wsoap_module = new EObjectContainmentEList<Wsoap_Module>(Wsoap_Module.class, this, WSDL2_0Package.BINDING_INPUT__WSOAP_MODULE);
		}
		return wsoap_module;
	}
	...
	public EList<Wsoap_Header> getWsoap_header() {
		if (wsoap_header == null) {
			wsoap_header = new EObjectContainmentEList<Wsoap_Header>(Wsoap_Header.class, this, WSDL2_0Package.BINDING_INPUT__WSOAP_HEADER);
		}
		return wsoap_header;
	}
	...
	public EList<Whttp_Header> getWhttp_header() {
		if (whttp_header == null) {
			whttp_header = new EObjectContainmentEList<Whttp_Header>(Whttp_Header.class, this, WSDL2_0Package.BINDING_INPUT__WHTTP_HEADER);
		}
		return whttp_header;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WSDL2_0Package.BINDING_INPUT__WSOAP_MODULE:
				return ((InternalEList<?>)getWsoap_module()).basicRemove(otherEnd, msgs);
			case WSDL2_0Package.BINDING_INPUT__WSOAP_HEADER:
				return ((InternalEList<?>)getWsoap_header()).basicRemove(otherEnd, msgs);
			case WSDL2_0Package.BINDING_INPUT__WHTTP_HEADER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WSDL2_0Package.BINDING_INPUT__MESSAGE_LABEL:
				return getMessageLabel();
			case WSDL2_0Package.BINDING_INPUT__WHTTP_CONTENT_ENCODING:
