...
public class ConservativeASDLaunchShortcut implements ILaunchShortcut {
	
	public static final String MODEL_CONFIGTYPE_ID = Activator.PLUGIN_ID + ".ConservativeASD_lct";
	...
	protected ILaunchConfiguration createConfiguration(String pathIN) {
		...
		try {
			...
			wc.setAttribute("outModel", new Path(pathIN).removeFileExtension().toOSString() + "-cons.xmi");
			config = wc.doSave();
