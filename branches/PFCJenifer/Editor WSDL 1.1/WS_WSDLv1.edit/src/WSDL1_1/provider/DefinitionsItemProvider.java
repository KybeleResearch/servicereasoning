...
/**
 * This is the item provider adapter for a {@link WSDL1_1.Definitions} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DefinitionsItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WSDL1_1Package.eINSTANCE.getDefinitions_Name(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WSDL1_1Package.eINSTANCE.getDefinitions_TargetNamespace(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getDefinitions_Binding());
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getDefinitions_Service());
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getDefinitions_PortType());
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getDefinitions_Message());
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getDefinitions_Types());
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getDefinitions_Namespace());
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getDefinitions_Import());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getDefinitions_Binding(),
				 WSDL1_1Factory.eINSTANCE.createBinding()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getDefinitions_Service(),
				 WSDL1_1Factory.eINSTANCE.createService()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getDefinitions_PortType(),
				 WSDL1_1Factory.eINSTANCE.createPortType()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getDefinitions_Message(),
				 WSDL1_1Factory.eINSTANCE.createMessage()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getDefinitions_Types(),
				 WSDL1_1Factory.eINSTANCE.createElementType()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getDefinitions_Namespace(),
				 WSDL1_1Factory.eINSTANCE.createNamespace()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getDefinitions_Import(),
				 WSDL1_1Factory.eINSTANCE.createImport()));
	}
