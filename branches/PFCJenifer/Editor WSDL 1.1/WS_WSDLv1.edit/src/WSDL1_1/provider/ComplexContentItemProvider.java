...
/**
 * This is the item provider adapter for a {@link WSDL1_1.ComplexContent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComplexContentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WSDL1_1Package.eINSTANCE.getComplexContent_Mixed(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WSDL1_1Package.eINSTANCE.getComplexContent_Id(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getComplexContent_Annotation());
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getComplexContent_Restriction());
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getComplexContent_Extension());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getComplexContent_Annotation(),
				 WSDL1_1Factory.eINSTANCE.createAnnotation()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getComplexContent_Restriction(),
				 WSDL1_1Factory.eINSTANCE.createRestriction()));

		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getComplexContent_Extension(),
