...
/**
 * This is the item provider adapter for a {@link WSDL1_1.Include} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IncludeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Include_schemaLocation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Include_schemaLocation_feature", "_UI_Include_type"),
				 WSDL1_1Package.eINSTANCE.getInclude_SchemaLocation(),
				 true,
				 false,
				 false,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Include_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Include_id_feature", "_UI_Include_type"),
				 WSDL1_1Package.eINSTANCE.getInclude_Id(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WSDL1_1Package.eINSTANCE.getInclude_Annotation());
		}
	...
	public String getText(Object object) {
		String label = ((Include)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WSDL1_1Package.eINSTANCE.getInclude_Annotation(),
