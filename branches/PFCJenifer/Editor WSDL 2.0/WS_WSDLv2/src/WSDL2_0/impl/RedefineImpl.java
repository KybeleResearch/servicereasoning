 ...
 * <ul>
 *   <li>{@link WSDL2_0.impl.RedefineImpl#getSchemaLocation <em>Schema Location</em>}</li>
 *   <li>{@link WSDL2_0.impl.RedefineImpl#getId <em>Id</em>}</li>
 *   <li>{@link WSDL2_0.impl.RedefineImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link WSDL2_0.impl.RedefineImpl#getSimpleType <em>Simple Type</em>}</li>
 *   <li>{@link WSDL2_0.impl.RedefineImpl#getComplexType <em>Complex Type</em>}</li>
 *   <li>{@link WSDL2_0.impl.RedefineImpl#getAttributeGroup <em>Attribute Group</em>}</li>
 *   <li>{@link WSDL2_0.impl.RedefineImpl#getGroup <em>Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RedefineImpl extends EObjectImpl implements Redefine {
	...
	protected EClass eStaticClass() {
		return WSDL2_0Package.eINSTANCE.getRedefine();
	}
	...
	public void setSchemaLocation(String newSchemaLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.REDEFINE__SCHEMA_LOCATION, oldSchemaLocation, schemaLocation));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.REDEFINE__ID, oldId, id));
	}
	...
	public EList<Annotation> getAnnotation() {
		if (annotation == null) {
			annotation = new EObjectContainmentEList<Annotation>(Annotation.class, this, WSDL2_0Package.REDEFINE__ANNOTATION);
		}
		return annotation;
	}
	...
	public EList<SimpleType> getSimpleType() {
		if (simpleType == null) {
			simpleType = new EObjectContainmentEList<SimpleType>(SimpleType.class, this, WSDL2_0Package.REDEFINE__SIMPLE_TYPE);
		}
		return simpleType;
	}
	...
	public EList<ComplexType> getComplexType() {
		if (complexType == null) {
			complexType = new EObjectContainmentEList<ComplexType>(ComplexType.class, this, WSDL2_0Package.REDEFINE__COMPLEX_TYPE);
		}
		return complexType;
	}
	...
	public EList<AttributeGroup> getAttributeGroup() {
		if (attributeGroup == null) {
			attributeGroup = new EObjectContainmentEList<AttributeGroup>(AttributeGroup.class, this, WSDL2_0Package.REDEFINE__ATTRIBUTE_GROUP);
		}
	...
	public EList<Group> getGroup() {
		if (group == null) {
			group = new EObjectContainmentEList<Group>(Group.class, this, WSDL2_0Package.REDEFINE__GROUP);
		}
		return group;
	}
