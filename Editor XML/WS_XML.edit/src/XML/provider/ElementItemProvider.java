...
/**
 * This is the item provider adapter for a {@link XML.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XMLPackage.Literals.ELEMENT__CHILDREN);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Element.class)) {
			case XMLPackage.ELEMENT__CHILDREN:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XMLPackage.Literals.ELEMENT__CHILDREN,
		...
		newChildDescriptors.add
			(createChildParameter
				(XMLPackage.Literals.ELEMENT__CHILDREN,
				 XMLFactory.eINSTANCE.createRoot()));
	}
