...
/**
 * This is the item provider adapter for a {@link WSDL2_0.Field} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Field_xpath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Field_xpath_feature", "_UI_Field_type"),
				 WSDL2_0Package.eINSTANCE.getField_Xpath(),
				 true,
				 false,
				 false,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Field_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Field_id_feature", "_UI_Field_type"),
				 WSDL2_0Package.eINSTANCE.getField_Id(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WSDL2_0Package.eINSTANCE.getField_Annotation());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Field.class)) {
			case WSDL2_0Package.FIELD__XPATH:
			case WSDL2_0Package.FIELD__ID:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case WSDL2_0Package.FIELD__ANNOTATION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WSDL2_0Package.eINSTANCE.getField_Annotation(),
