...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Binding Outfault</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link WSDL2_0.impl.BindingOutfaultImpl#getMessageLabel <em>Message Label</em>}</li>
 *   <li>{@link WSDL2_0.impl.BindingOutfaultImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link WSDL2_0.impl.BindingOutfaultImpl#getWsoap_module <em>Wsoap module</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BindingOutfaultImpl extends ObjectImpl implements BindingOutfault {
	/**
	...
	protected EClass eStaticClass() {
		return WSDL2_0Package.eINSTANCE.getBindingOutfault();
	}
	...
	public void setMessageLabel(String newMessageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.BINDING_OUTFAULT__MESSAGE_LABEL, oldMessageLabel, messageLabel));
	}
	...
	public InterfaceFault getRef() {
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WSDL2_0Package.BINDING_OUTFAULT__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(InterfaceFault newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL2_0Package.BINDING_OUTFAULT__REF, oldRef, ref));
	}
	...
	public EList<Wsoap_Module> getWsoap_module() {
		if (wsoap_module == null) {
			wsoap_module = new EObjectContainmentEList<Wsoap_Module>(Wsoap_Module.class, this, WSDL2_0Package.BINDING_OUTFAULT__WSOAP_MODULE);
		}
		return wsoap_module;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WSDL2_0Package.BINDING_OUTFAULT__REF:
