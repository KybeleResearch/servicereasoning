 ...
 *   <li>{@link ASD.impl.AssertionImpl#getRole <em>Role</em>}</li>
...
public class AssertionImpl extends NamedElementImpl implements Assertion {
	 ...
	 * @ordered
	 */
	protected EEnumIntention role = ROLE_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setRole(EEnumIntention newRole) {
		EEnumIntention oldRole = role;
		role = newRole == null ? ROLE_EDEFAULT : newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ASDPackage.ASSERTION__ROLE, oldRole, role));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ASDPackage.ASSERTION__DIMENSION_TYPE:
				...
				return;
			case ASDPackage.ASSERTION__ROLE:
				setRole((EEnumIntention)newValue);
				return;
			case ASDPackage.ASSERTION__MIN_VAL:
