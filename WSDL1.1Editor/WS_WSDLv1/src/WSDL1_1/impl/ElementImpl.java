 ...
 * <ul>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getMinOccurs <em>Min Occurs</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getMaxOccurs <em>Max Occurs</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getNillable <em>Nillable</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getAbstractDef <em>Abstract Def</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getFinal <em>Final</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getFixed <em>Fixed</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getForm <em>Form</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getComplexType <em>Complex Type</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getSimpleType <em>Simple Type</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getUniqueDef <em>Unique Def</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getKey <em>Key</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getKeyref <em>Keyref</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getSubstitutionGroup <em>Substitution Group</em>}</li>
 *   <li>{@link WSDL1_1.impl.ElementImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElementImpl extends AdicionalInformationTypeImpl implements Element {
	...
	protected EClass eStaticClass() {
		return WSDL1_1Package.eINSTANCE.getElement();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__NAME, oldName, name));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__ID, oldId, id));
	}
	...
	public void setMinOccurs(Integer newMinOccurs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__MIN_OCCURS, oldMinOccurs, minOccurs));
	}
	...
	public void setMaxOccurs(String newMaxOccurs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__MAX_OCCURS, oldMaxOccurs, maxOccurs));
	}
	...
	public void setNillable(Boolean newNillable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__NILLABLE, oldNillable, nillable));
	}
	...
	public void setAbstractDef(Boolean newAbstractDef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__ABSTRACT_DEF, oldAbstractDef, abstractDef));
	}
	...
	public void setFinal(String newFinal) {
		...
		final_ = newFinal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__FINAL, oldFinal, final_));
	}
	...
	public void setBlock(String newBlock) {
		...
		block = newBlock;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__BLOCK, oldBlock, block));
	}
	...
	public void setDefault(String newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__DEFAULT, oldDefault, default_));
	}
	...
	public void setFixed(String newFixed) {
		...
		fixed = newFixed;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__FIXED, oldFixed, fixed));
	}
	...
	public void setForm(formValues newForm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__FORM, oldForm, form));
	}
	...
	public NotificationChain basicSetAnnotation(Annotation newAnnotation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__ANNOTATION, oldAnnotation, newAnnotation);
	...
	public void setAnnotation(Annotation newAnnotation) {
		if (newAnnotation != annotation) {
			...
			if (annotation != null)
				msgs = ((InternalEObject)annotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.ELEMENT__ANNOTATION, null, msgs);
			if (newAnnotation != null)
				msgs = ((InternalEObject)newAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.ELEMENT__ANNOTATION, null, msgs);
			msgs = basicSetAnnotation(newAnnotation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__ANNOTATION, newAnnotation, newAnnotation));
	}
	...
	public NotificationChain basicSetComplexType(ComplexType newComplexType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__COMPLEX_TYPE, oldComplexType, newComplexType);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setComplexType(ComplexType newComplexType) {
		if (newComplexType != complexType) {
			NotificationChain msgs = null;
			if (complexType != null)
				msgs = ((InternalEObject)complexType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.ELEMENT__COMPLEX_TYPE, null, msgs);
			if (newComplexType != null)
				msgs = ((InternalEObject)newComplexType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.ELEMENT__COMPLEX_TYPE, null, msgs);
			msgs = basicSetComplexType(newComplexType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__COMPLEX_TYPE, newComplexType, newComplexType));
	}
	...
	public NotificationChain basicSetSimpleType(SimpleType newSimpleType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__SIMPLE_TYPE, oldSimpleType, newSimpleType);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSimpleType(SimpleType newSimpleType) {
		if (newSimpleType != simpleType) {
			NotificationChain msgs = null;
			if (simpleType != null)
				msgs = ((InternalEObject)simpleType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.ELEMENT__SIMPLE_TYPE, null, msgs);
			if (newSimpleType != null)
				msgs = ((InternalEObject)newSimpleType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WSDL1_1Package.ELEMENT__SIMPLE_TYPE, null, msgs);
			msgs = basicSetSimpleType(newSimpleType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__SIMPLE_TYPE, newSimpleType, newSimpleType));
	}
	...
	public EList<Unique> getUniqueDef() {
		if (uniqueDef == null) {
			uniqueDef = new EObjectContainmentEList<Unique>(Unique.class, this, WSDL1_1Package.ELEMENT__UNIQUE_DEF);
		}
		return uniqueDef;
	}
	...
	public EList<Key> getKey() {
		if (key == null) {
			key = new EObjectContainmentEList<Key>(Key.class, this, WSDL1_1Package.ELEMENT__KEY);
		}
		return key;
	}
	...
	public EList<KeyRef> getKeyref() {
		if (keyref == null) {
			keyref = new EObjectContainmentEList<KeyRef>(KeyRef.class, this, WSDL1_1Package.ELEMENT__KEYREF);
		}
		return keyref;
	}
	...
	public Element getRef() {
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WSDL1_1Package.ELEMENT__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(Element newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__REF, oldRef, ref));
	}
	...
	public Element getSubstitutionGroup() {
		if (substitutionGroup != null && substitutionGroup.eIsProxy()) {
			...
			if (substitutionGroup != oldSubstitutionGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WSDL1_1Package.ELEMENT__SUBSTITUTION_GROUP, oldSubstitutionGroup, substitutionGroup));
			}
		}
	...
	public void setSubstitutionGroup(Element newSubstitutionGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__SUBSTITUTION_GROUP, oldSubstitutionGroup, substitutionGroup));
	}
	...
	public TypeRef getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WSDL1_1Package.ELEMENT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(TypeRef newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WSDL1_1Package.ELEMENT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WSDL1_1Package.ELEMENT__KEYREF:
				return getKeyref();
			case WSDL1_1Package.ELEMENT__REF:
				if (resolve) return getRef();
				return basicGetRef();
			case WSDL1_1Package.ELEMENT__SUBSTITUTION_GROUP:
				if (resolve) return getSubstitutionGroup();
				return basicGetSubstitutionGroup();
			case WSDL1_1Package.ELEMENT__TYPE:
