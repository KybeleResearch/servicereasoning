...
import ASD.diagram.edit.policies.InfoType2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InfoType2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InfoType2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InfoType2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InfoTypeName3EditPart) {
			((InfoTypeName3EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureInfoTypeLabelFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeName4EditPart) {
			((InfoTypeName4EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureNamedElementNameLabelFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeValueType2EditPart) {
			((InfoTypeValueType2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureInfoTypeValueTypeLabelFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeValueRange2EditPart) {
			((InfoTypeValueRange2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureInfoTypeValueRangeLabelFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeSubset2EditPart) {
			((InfoTypeSubset2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureInfoTypeSubsetLabelFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeInfoTypeAnnotationsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getInfoTypeAnnotationsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InfoTypeInfoTypeAnnotationsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeInfoTypeInfoTypeCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getInfoTypeInfoTypeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InfoTypeInfoTypeInfoTypeCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof InfoTypeInfoTypeAnnotationsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getInfoTypeAnnotationsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((InfoTypeInfoTypeAnnotationsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof InfoTypeInfoTypeInfoTypeCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getInfoTypeInfoTypeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((InfoTypeInfoTypeInfoTypeCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ASDVisualIDRegistry
				.getType(InfoTypeName3EditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ASD.diagram.edit.parts.InfoType2EditPart) {
			types.add(ASDElementTypes.InfoTypeRef_4002);
		}
		return types;
	}
