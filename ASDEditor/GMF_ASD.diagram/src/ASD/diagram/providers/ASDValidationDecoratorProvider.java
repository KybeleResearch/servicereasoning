 ...
 * @generated
 */
public class ASDValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = ASDDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ASDDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ServiceDescriptionEditPart.MODEL_ID
						.equals(ASDVisualIDRegistry.getModelID(view));
	}
