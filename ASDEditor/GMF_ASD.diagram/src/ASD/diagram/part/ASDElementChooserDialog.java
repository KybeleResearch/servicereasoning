 ...
 * @generated
 */
public class ASDElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ASDElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.ASDElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "xmi".equals(fileExtension); //$NON-NLS-1$
	}
