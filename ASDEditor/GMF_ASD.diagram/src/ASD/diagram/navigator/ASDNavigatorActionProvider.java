...
import ASD.diagram.part.ASDDiagramEditor;
 ...
 * @generated
 */
public class ASDNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof ASDNavigatorItem) {
					selectedElement = ((ASDNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (ServiceDescriptionEditPart.MODEL_ID
							.equals(ASDVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, ASDDiagramEditor.ID);
