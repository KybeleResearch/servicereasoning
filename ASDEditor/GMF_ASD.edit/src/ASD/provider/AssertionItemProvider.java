  ...
  protected void addIntentionPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Assertion_intention_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Assertion_intention_feature", "_UI_Assertion_type"),
         ASDPackage.Literals.ASSERTION__INTENTION,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
