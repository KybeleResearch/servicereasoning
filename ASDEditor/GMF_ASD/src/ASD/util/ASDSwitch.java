...
public class ASDSwitch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case ASDPackage.INFO_TYPE:
      {
        InfoType infoType = (InfoType)theEObject;
        T result = caseInfoType(infoType);
        if (result == null) result = caseNamedElement(infoType);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ASDPackage.PROFILE:
      {
      ...
      case ASDPackage.ASSERTION_SET:
      {
        AssertionSet assertionSet = (AssertionSet)theEObject;
        T result = caseAssertionSet(assertionSet);
        if (result == null) result = caseNamedElement(assertionSet);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ASDPackage.ASSERTION:
      {
      ...
      case ASDPackage.INFO_TYPE_IMPORTED:
      {
        InfoTypeImported infoTypeImported = (InfoTypeImported)theEObject;
        T result = caseInfoTypeImported(infoTypeImported);
        if (result == null) result = caseInfoType(infoTypeImported);
        if (result == null) result = caseNamedElement(infoTypeImported);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Info Type Imported</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Info Type Imported</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseInfoTypeImported(InfoTypeImported object)
  {
    return null;
  }
