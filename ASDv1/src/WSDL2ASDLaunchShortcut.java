...
public class WSDL2ASDLaunchShortcut implements ILaunchShortcut {
	
	public static final String MODEL_CONFIGTYPE_ID = Activator.PLUGIN_ID + ".WSDL2ASDv1_lct";
	...
	protected ILaunchConfiguration createConfiguration(String pathIN) {
		...
		try {
			...
			wc.setAttribute("outModel", new Path(pathIN).removeFileExtension().toOSString() + "-asd.xmi");
			config = wc.doSave();
