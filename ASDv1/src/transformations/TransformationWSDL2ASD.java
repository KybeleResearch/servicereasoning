...
public class TransformationWSDL2ASD {
	...
	private Object execution(IProgressMonitor monitor) throws Exception {
		...
		launcher.addLibrary("ASDHelpersv1", getLibraryAsStream("ASDHelpersv1"));
	...
	private void loadProperties() throws Exception {
		...
		properties.load(getFileURL("WSDL2ASDv1.properties").openStream());
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("ecore", new EcoreResourceFactoryImpl());	
	}
	
	protected InputStream[] getModulesList() throws IOException {
		InputStream[] modules = null;
		String modulesList = properties.getProperty("WSDL2ASDv1.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("WSDL2ASDv1.metamodels." + metamodelName);
	}
	
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("WSDL2ASDv1.libraries." + libraryName)).openStream();
	}
	
	protected Map<String, Object> getOptions() {
		Map<String, Object> options = new HashMap<String, Object>();
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("WSDL2ASDv1.options.")) {
				options.put(entry.getKey().toString().replaceFirst("WSDL2ASDv1.options.", ""), 
